...
impl Line {
    ...
    fn replacement_character(for_str: &str) -> Option<char> {
        ...
        match for_str {
            " " => None,
            "\t" => Some(' '),
            // The part before => checks the if-statement before proceeding to the matching arm.
            // The _ indicates that this should happen for any value of for_str that hasn't been handled yet.
        ...
        for fragment in &self.fragments {
            ...
            if fragment_end > range.start {
                if fragment_end > range.end || current_pos < range.start {
                    ...
                    result.push_str(&fragment.grapheme); // we push the grapheme after handling edge cases
                }
            }
